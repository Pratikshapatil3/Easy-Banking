    ...
    private void addAccount(String accountType) {
        ...
        System.out.println("username new" + username1);
            if (accountType.equals("CheckingAcc")) {
                ...
                Model.getInstance().getDatabaseDriver().addCheckingAcc(username1, accNumber, 10.0, amount);
            } else {
                Model.getInstance().getDatabaseDriver().addSavingAcc(username1, accNumber, 20.0, amount_savings);
            }
